...
public class Create_profile_oldu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_profile_oldu);

        Intent oldint = getIntent();
        String uname = oldint.getStringExtra("olduser");
        ...
        generateQrBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(dataEdt)) {
                    ...
                    Toast.makeText(Create_profile_oldu.this, "Enter some text to generate QR Code", Toast.LENGTH_SHORT).show();
                } else {
